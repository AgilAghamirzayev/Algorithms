...
public class AStar {
    ...
    public void updateCostIdNeeded(Cell current, Cell t, int cost) {
    ...
    public void process() {
        ...
        while (true) {
            ...
            if (current.i - 1 >= 0) {
                ...
                updateCostIdNeeded(current, t, current.finalCost + V_H_COST);

                if (current.j - 1 >= 0) {
                    t = grid[current.i - 1][current.j - 1];
                    updateCostIdNeeded(current, t, current.finalCost + DIAGONAL_COST);
                }
    ...
    public void displaySolution() {
        if (closedCells[endI][endJ]) {
            ...
            while (current.parents != null) {
                System.out.print(" -> " + current.parents);
                grid[current.parents.i][current.parents.j].solution = true;
